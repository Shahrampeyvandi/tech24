...
{{--                    </div>--}}
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="{{URL::asset('images/users/avatar-2.jpg')}}" alt="Header Avatar">
                        <span class="d-none d-xl-inline-block ml-1">{{ Auth::user()->mobile }}</span>
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{URL::asset('assets/imgs/Logo.png')}}" alt="" height="70">
                        </span>
                        <span class="logo-lg">
                            <img src="{{URL::asset('assets/imgs/Logo.png')}}" alt="" height="70">
                        </span>
