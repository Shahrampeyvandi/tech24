            ...
            <div class="col-lg-9">
                ...
                <div class="row mr-1">
                    ...
                    <div class="product_box product text-right row">
                      ...
                      <div class="col-xl-8 col-lg-12 col-sm-12 col-xs-12 py-2 text-right product-content">
                          ...
                          <div class="product_details float-left ml-2">
                              <div class="cost d-flex align-items-center">
                                  ...
                                  <a href="{{ $post->url() }}" class="py-2 px-5 btn_orange mr-4 mt-2">مشاهده</a>
                              </div>
                          </div>
                      </div>
                  </div>
