...
@font-face {
	font-family: "primary";
	src: url("techone24.com/assets/fonts/iran-sans-300.eot");
	src: url("techone24.com/assets/fonts/iran-sans-300.eot?#iefix") format("embedded-opentype"),
		 url("techone24.com/assets/fonts/iran-sans-300.woff2") format("woff2"),
		 url("techone24.com/assets/fonts/iran-sans-300.woff") format("woff"),
		 url("techone24.com/assets/fonts/iran-sans-300.ttf") format("truetype");
	font-weight: 300;
}
* {
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px"><p style="color:#262626; font-size:24px; text-align:right; font-family: primary, Geneva, sans-serif"><strong>{{ $user->fname ?? 'کاربر' }} عزیز </strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:right; font-family: primary, Geneva, sans-serif; line-height:22px ">
                     @if (isset($post))
                        ...
                        <tbody>
                          <tr>
                            <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                <tr>
                                  <td width="250" height="60" align="center" bgcolor="#1f3ca6" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="{{ route('member.posts', ['user' => $user->username, 'post_type' => $post->post_type]) }}" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: inherit; color: #ffffff" class="button_link">مشاهده<img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/582dc751-b0fc-4769-ad74-35932c7594dd.png" width="32" height="17" style="padding-top:5px" alt="" border="0"/></a></td>
                                </tr>
                              </table></td>
                          </tr>
                        </tbody>
                      </table>
                      <p style="color:#000000; font-size:16px; text-align:right; font-family: primary, Geneva, sans-serif; line-height:22px "><br />
                        <br />
                        <br />
                        <br />
                        <br />
                       تکوان 24, <br />
                        امنیت و اطلاعات </p></td>
                  </tr>
                </table>
