        ...
        <div class="card">
            <div class="card-body">
                <div class="text-right">
                    <a  class="btn btn-primary mr-auto mb-3" href="{{URL::route('questions.index')}}">لیست {{$title}} ها</a>
                </div>
                <form action="{{URL::route('questions.store')}}{{isset($quiz) ? '?action=edit' : ''}}" method="post">
                    @csrf
                    @isset($quiz)
